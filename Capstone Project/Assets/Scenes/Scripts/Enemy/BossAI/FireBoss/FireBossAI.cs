        ...
        while (startPhaseThree)
        {
            ...
            if (!attackLock)
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    yield return new WaitForSeconds(.1f);
                    StartCoroutine(ProjectileArc(324, 2, 3, 1));
                    yield return new WaitForSeconds(.1f);
                    StartCoroutine(ProjectileArc(288, 2, 3, 1));
                    yield return new WaitForSeconds(.1f);
                    StartCoroutine(ProjectileArc(252, 2, 3, 1));
                    yield return new WaitForSeconds(.1f);
                    StartCoroutine(ProjectileArc(216, 2, 3, 1));
                    yield return new WaitForSeconds(.1f);
                    StartCoroutine(ProjectileArc(180, 2, 3, 1));
                    yield return new WaitForSeconds(.1f);
                    StartCoroutine(ProjectileArc(144, 2, 3, 1));
                    yield return new WaitForSeconds(.1f);
                    StartCoroutine(ProjectileArc(108, 2, 3, 1));
                    yield return new WaitForSeconds(.1f);
                    StartCoroutine(ProjectileArc(72, 2, 3, 1));
                    yield return new WaitForSeconds(.1f);
