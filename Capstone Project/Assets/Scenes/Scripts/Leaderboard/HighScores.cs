...
{
    const string privateCode = "yb7MZJY4o0eadzDh_ULp-AWyNx95JkLU6MocHAymUfHg";  //Key to Upload New Info
    const string publicCode = "67a3de918f40bb16d8c1dd24";   //Key to download
